...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'http://localhost:3000', 'https://main--neon-cheesecake-5d962c.netlify.app/', 'http://localhost:3000', 'https://my-react-app-virid-psi.vercel.app/' ); // Replace with your frontend's URL
